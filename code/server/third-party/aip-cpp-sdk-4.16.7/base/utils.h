...
namespace aip {
    ...
    {
        std::transform(src.begin(), src.end(), src.begin(), /*原内容:toupper*/[](unsigned char c) { return std::toupper(c); });
        return src;
    }
    ...
    {
        std::transform(src.begin(), src.end(), src.begin(), /*原内容:tolower*/[](unsigned char c) { return std::tolower(c); });
        return src;
    }
